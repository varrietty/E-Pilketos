                            ...
                            <tbody>
                                <?php foreach ($data_pemilih_data as $data_pemilih) : ?>
                                    <tr>
                                        ...
                                        <th height="65px"><?php echo htmlspecialchars($data_pemilih->nama, ENT_QUOTES, 'UTF-8'); ?></td>
                                        <td style="text-align: center"><?php echo htmlspecialchars($data_pemilih->kelas, ENT_QUOTES, 'UTF-8'); ?></td>
										<td style="text-align: center"><?php echo $data_pemilih->username ?></td>
										<td style="text-align: center"><?php echo $data_pemilih->password ?></td>
