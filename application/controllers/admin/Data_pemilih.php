...
class Data_pemilih extends CI_Controller
{
    ...
    public function index()
    {
        ...
        if ($q <> '') {
            $config['base_url'] = base_url() . 'admin/data_pemilih/index?q=' . urlencode($q);
            $config['first_url'] = base_url() . 'admin/data_pemilih/index?q=' . urlencode($q);
        } else {
            $config['base_url'] = base_url() . 'admin/data_pemilih/index';
            $config['first_url'] = base_url() . 'admin/data_pemilih/index';
        }
